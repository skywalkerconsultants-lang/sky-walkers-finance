...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Modern accounting, VAT filing, corporate tax, payroll and business setup services for UAE startups, SMEs and free zone companies." },
      { property: "og:site_name", content: "Sky Walkers Consultancy" },
